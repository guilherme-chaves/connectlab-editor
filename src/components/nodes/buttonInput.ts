...
import {ButtonInput as ButtonInputModel} from '@connectlab-editor/models/input';
...
class ButtonInput implements Node {
  ...
  constructor(
    ...
    this.nodeType = ButtonInputModel;
  ...
  onEvent(ev: EditorEvents): boolean {
    switch (ev) {
      case EditorEvents.MOUSE_CLICKED:
        this.state = true;
        break;
